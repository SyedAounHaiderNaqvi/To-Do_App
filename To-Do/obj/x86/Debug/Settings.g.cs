...
namespace To_Do
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            ISettings_Bindings
        {
            ...
            {
                if (lineNumber == 31 && columnNumber == 89)
                {
                    isobj4FillDisabled = true;
                }
                else if (lineNumber == 33 && columnNumber == 154)
                {
                ...
                else if (lineNumber == 41 && columnNumber == 72)
                {
                ...
                else if (lineNumber == 58 && columnNumber == 251)
                {
            ...
            ISettings_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 150 && columnNumber == 71)
                {
